    ...
    void)
{
	...
	assert(hwloc_get_nbobjs_inside_cpuset_by_depth(topology, hwloc_topology_get_allowed_cpuset(topology),
						shep_depth) > 0);
	...
	qthread_debug(ALL_DETAILS,
		      ...
		      (unsigned int)hwloc_get_nbobjs_by_depth(topology, HWLOC_OBJ_PU));
...
{				       /*{{{ */
    ...
    hwloc_obj_t obj = hwloc_get_obj_inside_cpuset_by_depth(topology, allowed_cpuset, shep_depth, me->node);
