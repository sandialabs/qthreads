...
"shepherd_spawn" in qthread.c. Certain runtimes that might use this functionality 
...
The following program is a simple test of the the shepherd_spawn functionality
in action.

\lstinputlisting{test/basics/spawn_shepard.c}
