...
class Storage<C, Ref, VarT2> {
  // Using pointers to avoid confusion when qthread switches stack frame
  // pointers
  VarT2 *tp_;
protected:
...
#define CALL_5_ARG(fff)                                                        \
  fff(Storage<1, Arg1B, Arg1V>::value(cur),                                    \
...
#define CALL_4_ARG(fff)                                                        \
  fff(Storage<1, Arg1B, Arg1V>::value(cur),                                    \
      Storage<2, Arg2B, Arg2V>::value(cur),                                    \
      Storage<3, Arg3B, Arg3V>::value(cur),                                    \
      Storage<4, Arg4B, Arg4V>::value(cur))

#define CALL_3_ARG(fff)                                                        \
  fff(Storage<1, Arg1B, Arg1V>::value(cur),                                    \
      Storage<2, Arg2B, Arg2V>::value(cur),                                    \
      Storage<3, Arg3B, Arg3V>::value(cur))

#define CALL_2_ARG(fff)                                                        \
  fff(Storage<1, Arg1B, Arg1V>::value(cur),                                    \
      Storage<2, Arg2B, Arg2V>::value(cur))
...
#define C_RUN_OBJ(nnn)                                                         \
  void run(int cur) {                                                          \
    ...
    Storage<0, RetB, RetV>::update(cur, CALL_N_ARG((obj->*(fptr_)), nnn));     \
  }

#define C_RUN(nnn)                                                             \
  void run(int cur) {                                                          \
    Storage<0, RetB, RetV>::update(cur, CALL_N_ARG(fptr_, nnn));               \
  }
...
#define C_VOID_RUN(nnn)                                                        \
  void run(const unsigned int cur) { CALL_N_ARG(fptr_, nnn); }
...
template <class FptrT, class Arg1B, class Arg2B, class Arg1V, class Arg2V>
C_BODY(void,
       void,
       Arg1B,
       Arg2B,
...
class IterArg :
  ...
  typedef RunFunc<FptrT,
    ...
    runner;
public:
  virtual void Run() { runner::run(cur_); }
...
/* This seems to be the function that does the real work, namely, running the
 * iter->Run() function */
