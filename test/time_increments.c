...
int main(int argc, char *argv[])
{
    ...
    printf("\tBalanced increment loop: %19g secs (%u-threads %u iters)\n", qtimer_secs(timer), shepherds, ITERATIONS*MAXPARALLELISM);
    ...
    printf("\tBalanced increment weak loop: %14g secs (%u-threads %u iters)\n", qtimer_secs(timer), shepherds, ITERATIONS*256);
    printf("\t + average increment time: %17g secs\n",
    ...
    printf("\tCompeting increment loop: %18g secs (%u-threads %u iters)\n", qtimer_secs(timer), MAXPARALLELISM, ITERATIONS);
    printf("\t + average increment time: %17g secs\n",
	   qtimer_secs(timer) / (ITERATIONS*MAXPARALLELISM));
    printf("\t = increment throughput: %'19f increments/sec\n",
	   (ITERATIONS*MAXPARALLELISM) / qtimer_secs(timer));
    ...
    printf("\tNon-competing increment loop: %14g secs (%u-threads %u iters)\n", qtimer_secs(timer), MAXPARALLELISM, ITERATIONS);
    printf("\t + average increment time: %17g secs\n",
	   qtimer_secs(timer) / (ITERATIONS*MAXPARALLELISM));
    printf("\t = increment throughput: %'19f increments/sec\n",
	   (ITERATIONS*MAXPARALLELISM) / qtimer_secs(timer));
    ...
    printf("\tNon-competing weak-scaling loop: %11g secs (%u-threads %u iters)\n", qtimer_secs(timer), shepherds, ITERATIONS);
    printf("\t + average increment time: %17g secs\n",
    ...
    printf("\tNon-competing add loop: %20g secs (%u-way %u iters)\n", qtimer_secs(timer), MAXPARALLELISM, ITERATIONS);
    printf("\t + average increment time: %17g secs\n",
	   qtimer_secs(timer) / (ITERATIONS*MAXPARALLELISM));
    printf("\t = increment throughput: %'19f increments/sec\n",
	   (ITERATIONS*MAXPARALLELISM) / qtimer_secs(timer));
