    ...
    return (-1);
{
  ...
  __out_argv2__1527__.OUT__2__1527___data::len1_p = ((void *)(&len1));
  __out_argv2__1527__.OUT__2__1527___data::sj_p = ((void *)(&sj));
  __out_argv2__1527__.OUT__2__1527___data::m_p = ((void *)(&m));
  __out_argv2__1527__.OUT__2__1527___data::n_p = ((void *)(&n));
  __out_argv2__1527__.OUT__2__1527___data::i_p = ((void *)(&i));
  XOMP_parallel_start(OUT__2__1527__,&__out_argv2__1527__,0);
  XOMP_parallel_end();
{
    if ((bots_verbose_mode) >= (BOTS_VERBOSE_DEFAULT)) {
  ...
  nseqs = readseqs(1,filename);
{
  ...
  for (i = 1; i <= nseqs; i++) {
    if ((bots_verbose_mode) >= (BOTS_VERBOSE_DEBUG)) {
      fprintf(stdout,"%s:%d:%s:Sequence %d: %s %6.d aa\n","alignment.c",581,__func__,i,(names[i]),(seqlen_array[i]));
    }
  }
  ktup = 1;
  window = 5;
  ...
  for (i = 0; i < nseqs; i++) 
    for (j = 0; j < nseqs; j++) 
      if ((bench_output[(i * nseqs) + j]) != 0) {
        if ((bots_verbose_mode) >= (BOTS_VERBOSE_DEBUG)) {
          fprintf(stdout,"%s:%d:%s:Benchmark sequences (%d:%d) Aligned. Score: %d\n","alignment.c",630,__func__,(i + 1),(j + 1),(bench_output[(i * nseqs) + j]));
        }
      }
}
...
static void OUT__2__1527__(void *__out_argv)
{
  int i = *(int *)(((struct OUT__2__1527___data *)__out_argv) -> OUT__2__1527___data::i_p);
  int n = *(int *)(((struct OUT__2__1527___data *)__out_argv) -> OUT__2__1527___data::n_p);
  int m = *(int *)(((struct OUT__2__1527___data *)__out_argv) -> OUT__2__1527___data::m_p);
  int sj = *(int *)(((struct OUT__2__1527___data *)__out_argv) -> OUT__2__1527___data::sj_p);
  int len1 = *(int *)(((struct OUT__2__1527___data *)__out_argv) -> OUT__2__1527___data::len1_p);
{
    long _p_index;
    long _p_lower;
    long _p_upper;
    XOMP_loop_dynamic_init(0,nseqs - 1 + 1,1,1);
    if (XOMP_loop_dynamic_start(0,nseqs - 1 + 1,1,1,&_p_lower,&_p_upper)) {
      do {
        for (_p_index = _p_lower; _p_index <= _p_upper + -1; _p_index += 1) {
          if (( n = (seqlen_array[_p_index + 1])) != 0) {
            for ((( i = 1) ,  len1 = 0);  i <=  n; ( i)++) {
              char c = ((seq_array[_p_index + 1])[ i]);
              if (((c) != gap_pos1) && ((c) != gap_pos2)) 
                ( len1)++;
            }
            printf("len %p %d n %d\n",&( len1), len1, n);
            for ( sj = (_p_index + 1);  sj < nseqs; ( sj)++) {
              if (( m = (seqlen_array[ sj + 1])) != 0) {
                struct OUT__1__1527___data __out_argv1__1527__;
                __out_argv1__1527__.OUT__1__1527___data::len1 =  &len1;
                __out_argv1__1527__.OUT__1__1527___data::sj =  &sj;
                __out_argv1__1527__.OUT__1__1527___data::si = _p_index;
                __out_argv1__1527__.OUT__1__1527___data::m =  &m;
                __out_argv1__1527__.OUT__1__1527___data::n =  &n;
                XOMP_task(OUT__1__1527__,&__out_argv1__1527__,0,40,8,1,1);
              }
            }
          }
        }
      }while (XOMP_loop_dynamic_next(&_p_lower,&_p_upper));
    }
    XOMP_loop_end();
  }
}
