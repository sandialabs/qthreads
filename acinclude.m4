dnl This is a version of AC_C_STD_TRY stolen directly from autoconf 2.60
AC_DEFUN([QTHREAD_C_STD_TRY],
...
dnl This is a version of AC_PROG_CC_C99 stolen directly from autoconf 2.60 (the
dnl reason I stole it rather than simply require autoconf 2.60 is because MacOS
dnl X 10.4 doesn't have it by default).
AC_DEFUN([QTHREAD_PROG_CC_C99],
[QTHREAD_C_STD_TRY([c99],
[[#include <stdarg.h>
#include <stdbool.h>
#include <stdlib.h>
#include <wchar.h>
...
AC_CACHE_VAL(AC_CV_NAME,
	[for ac_size in $3 ; do # List sizes in rough order of prevalence.
