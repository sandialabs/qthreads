...
There is also an experimental interface for qthreads using C++26 senders under development at [github.com/sandialabs/qthreads-stdexec.git](github.com/sandialabs/qthreads-stdexec.git).
